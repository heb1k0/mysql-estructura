...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2021 a las 11:24:52
...
CREATE TABLE `clients` (
  ...
  `registre` timestamp NULL DEFAULT current_timestamp(),
  `ulleres_id` int(11) DEFAULT NULL,
  `id_client_recomenat` int(11) DEFAULT NULL
...
CREATE TABLE `ulleres` (
  ...
  `colormontura` varchar(10) DEFAULT NULL,
...
ALTER TABLE `clients`
  ...
  ADD CONSTRAINT `clients_ibfk_3` FOREIGN KEY (`id`) REFERENCES `clients` (`id_client_recomenat`);

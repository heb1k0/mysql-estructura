...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2021 a las 11:40:40
...
INSERT INTO `clients` (`id`, `nom`, `cp`, `email`, `telefon`, `registre`, `ulleres_id`, `id_client_recomenat`) VALUES
(1, 'alex', 8780, 'alejandro@zuriguel.com', '1313', '2021-11-02 11:34:51', NULL, 0);
...
ALTER TABLE `ulleres`
  ...
  ADD CONSTRAINT `ulleres_ibfk_5` FOREIGN KEY (`id`) REFERENCES `clients` (`ulleres_id`);
COMMIT;
